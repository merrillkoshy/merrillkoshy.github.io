...
const data: Data[] = [
  {
    Incomlend: {
      ...
      year: 2022,
      url: "https://app.incomlend.com",
      details: `FinTech Platform architecture, development & tooling. 
			• Squad collaboration using Slack and management using JIRA. CI/CD, issue-tracking and code review through GitLab & GitHub.
			• Architecture & Development of an entire platform which seamlessly integrates the trade financing experience of our clients with numerous departments within the company.
			• Empowering every department on their day-to-day with precision abstraction, data processing, ML & AI, thereby optimizing turnarounds and eliminating manual processes.
			• Development Stack: ReactJS TypeScript PWA | MUI, Formik, Storybook, NPM, RollupJS | ESLint | Postgres-Python.`,
    },
  },
  {
    LCLite: {
      ...
      details: `Web3 FinTech Platform tooling. Tasked with Software Architecture Rationalisation, developing the component library required to be used in both platforms. 
